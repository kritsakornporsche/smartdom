    ...
    <div className="min-h-screen bg-[#faf9f6] text-[#2d2a26] selection:bg-primary/20">
      ...
      <footer className="py-20 bg-white border-t border-black/5">
        <div className="max-w-7xl mx-auto px-8 flex flex-col items-center">
            <p className="text-sm font-black uppercase tracking-wider text-muted-foreground/40 mb-4">The new standard of living</p>
            ...
            <p className="text-xs text-muted-foreground font-medium text-center max-w-sm leading-normal">
