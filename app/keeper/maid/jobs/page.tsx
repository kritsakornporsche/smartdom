...
const statusConfig: Record<string, { label: string; bg: string }> = {
  pending: { label: 'จัดคิว', bg: 'bg-rose-100 text-rose-700' },
  in_progress: { label: 'กำลังทำ', bg: 'bg-amber-100 text-amber-700' },
  completed: { label: 'เสร็จสิ้น', bg: 'bg-emerald-100 text-emerald-700' },
};

const jobTypeConfig: Record<string, string> = {
  move_out: 'ย้ายออก (ทำความสะอาดใหญ่)',
  weekly: 'รายสัปดาห์',
  requested: 'ผู้เช่าร้องขอพิเศษ',
};
          ...
          <div className="max-w-5xl mx-auto space-y-8">
            <section className="bg-[#FAF8F5] border border-[#E5DFD3] rounded-3xl shadow-sm overflow-hidden">
              <div className="px-7 py-5 border-b border-[#E5DFD3] flex items-center justify-between bg-white">
                <div>
                  <h2 className="font-display text-base font-bold text-[#3E342B]">รายการคิวงานทั้งหมด</h2>
