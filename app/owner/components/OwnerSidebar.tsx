    ...
    <>
      ...
      <header className="h-16 bg-[#0F172A] border-b border-white/20 flex items-center justify-between px-6 shrink-0 z-40 sticky top-0 shadow-sm">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-blue-500 to-indigo-700 flex items-center justify-center font-black text-white text-lg shadow-lg flex-shrink-0">
            S
          </div>
