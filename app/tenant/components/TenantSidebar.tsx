...
const navItems = [
  ...
  {
    href: '/tenant/vehicles',
    label: 'ยานพาหนะ (Vehicles)',
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export default function TenantSidebar() {
  ...
  return (
    <aside className="w-64 bg-[#FAF8F5] border-r border-[#E5DFD3] flex flex-col hidden md:flex shrink-0 shadow-sm">
      {/* Logo */}
