...
conn.on('ready', () => {
  ...
  const cmd = 'cd /d D:\\kritsakorn\\smartdom && git pull origin main && npm install && npx pm2 kill && timeout /t 2 && rmdir /s /q .next && npm run build && npx pm2 start ecosystem.config.js --update-env';
