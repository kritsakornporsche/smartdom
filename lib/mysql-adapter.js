...
function getPool(connectionString) {
  ...
  if (url.startsWith('postgres://') || url.startsWith('postgresql://')) {
    console.warn("Using Postgres URL with MySQL adapter, converting to local MySQL: mysql://root:@localhost:3306/smartdomdb");
    url = 'mysql://root:@localhost:3306/smartdomdb';
  }
