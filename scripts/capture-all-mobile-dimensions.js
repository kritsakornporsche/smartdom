...
async function saveScreenshot(page, filename) {
  ...
  console.log(`📱 [MOBILE CAPTURED] -> ${filename}`);
}
...
(async () => {
  console.log('📱🚀 STARTING ALL-DIMENSION MOBILE SCREENSHOT CAPTURE (390x844 iPhone Viewport)...');
  ...
  try {
    // ==========================================
    // 1. PUBLIC & GUEST MOBILE
    // ==========================================
    console.log('\n🌐 --- 1. Public & Guest Dimension (Mobile) ---');
    await page.goto(`${BASE_URL}/`, { waitUntil: 'networkidle2' });
    await waitForPageReady(page, 1500);
    await saveScreenshot(page, 'mobile_01_landing_page.png');

    await page.goto(`${BASE_URL}/explore`, { waitUntil: 'networkidle2' });
    await waitForPageReady(page, 2000);
    await saveScreenshot(page, 'mobile_02_explore_search.png');

    await page.goto(`${BASE_URL}/explore/1`, { waitUntil: 'networkidle2' });
    await waitForPageReady(page, 2000);
    await saveScreenshot(page, 'mobile_03_dorm_detail_kaset2.png');

    await page.goto(`${BASE_URL}/signin`, { waitUntil: 'networkidle2' });
    await waitForPageReady(page, 1000);
    await saveScreenshot(page, 'mobile_04_signin_portal.png');

    await page.goto(`${BASE_URL}/signup`, { waitUntil: 'networkidle2' });
    await waitForPageReady(page, 1000);
    await saveScreenshot(page, 'mobile_05_signup_portal.png');

    // ==========================================
    // 2. OWNER PORTAL MOBILE
    // ==========================================
    console.log('\n👑 --- 2. Owner Portal Full Dimension (Mobile) ---');
    await page.goto(`${BASE_URL}/signin`, { waitUntil: 'networkidle2' });
    ...
    await saveScreenshot(page, 'mobile_06_owner_dashboard.png');

    // Rooms Grid
    await page.goto(`${BASE_URL}/owner/rooms`, { waitUntil: 'networkidle2' });
    await waitForPageReady(page, 2500);
    await saveScreenshot(page, 'mobile_07_owner_rooms_grid.png');
    ...
    if (addRoomBtn) {
      ...
      await sleep(1000);
      await saveScreenshot(page, 'mobile_08_owner_add_room_modal.png');
    ...
    if (batchBtn) {
      ...
      await sleep(1000);
      await saveScreenshot(page, 'mobile_09_owner_batch_rooms_modal.png');
    }

    // Tenants Directory
    await page.goto(`${BASE_URL}/owner/tenants`, { waitUntil: 'networkidle2' });
    await waitForPageReady(page, 2500);
    await saveScreenshot(page, 'mobile_10_owner_tenants_directory.png');

    // Meters Recording
    await page.goto(`${BASE_URL}/owner/meters`, { waitUntil: 'networkidle2' });
    await waitForPageReady(page, 2500);
    await saveScreenshot(page, 'mobile_11_owner_meters_recording.png');

    // Billing History
    await page.goto(`${BASE_URL}/owner/billing`, { waitUntil: 'networkidle2' });
    await waitForPageReady(page, 2500);
    await saveScreenshot(page, 'mobile_12_owner_billing_history.png');

    // Maintenance Management
    await page.goto(`${BASE_URL}/owner/maintenance`, { waitUntil: 'networkidle2' });
    await waitForPageReady(page, 2500);
    await saveScreenshot(page, 'mobile_13_owner_maintenance_management.png');

    // Contracts Management
    await page.goto(`${BASE_URL}/owner/contracts`, { waitUntil: 'networkidle2' });
    await waitForPageReady(page, 2500);
    await saveScreenshot(page, 'mobile_14_owner_contracts_management.png');

    // Accounting & Reports
    await page.goto(`${BASE_URL}/owner/accounting`, { waitUntil: 'networkidle2' });
    await waitForPageReady(page, 2500);
    await saveScreenshot(page, 'mobile_15_owner_accounting_reports.png');

    // Keepers Staff
    await page.goto(`${BASE_URL}/owner/keepers`, { waitUntil: 'networkidle2' });
    await waitForPageReady(page, 2500);
    await saveScreenshot(page, 'mobile_16_owner_keepers_staff.png');

    // Settings
    await page.goto(`${BASE_URL}/owner/settings`, { waitUntil: 'networkidle2' });
    await waitForPageReady(page, 2500);
    await saveScreenshot(page, 'mobile_17_owner_settings_promptpay.png');

    // Subscription Status
    await page.goto(`${BASE_URL}/owner/subscription`, { waitUntil: 'networkidle2' });
    await waitForPageReady(page, 2500);
    await saveScreenshot(page, 'mobile_18_owner_subscription_status.png');

    // ==========================================
    // 3. TENANT PORTAL MOBILE
    // ==========================================
    console.log('\n🧑‍🎓 --- 3. Tenant Portal Full Dimension (Mobile) ---');
    await page.goto(`${BASE_URL}/signin`, { waitUntil: 'networkidle2' });
    ...
    await waitForPageReady(page, 2500);
    await saveScreenshot(page, 'mobile_19_tenant_dashboard.png');

    // Tenant Billing
    await page.goto(`${BASE_URL}/tenant/billing`, { waitUntil: 'networkidle2' });
    await waitForPageReady(page, 2500);
    await saveScreenshot(page, 'mobile_20_tenant_billing_list.png');
    ...
    await saveScreenshot(page, 'mobile_21_tenant_promptpay_qr_modal.png');

    // Tenant Maintenance
    await page.goto(`${BASE_URL}/tenant/maintenance`, { waitUntil: 'networkidle2' });
    await waitForPageReady(page, 2500);
    await saveScreenshot(page, 'mobile_22_tenant_maintenance_history.png');

    // Tenant Contract
    await page.goto(`${BASE_URL}/tenant/contract`, { waitUntil: 'networkidle2' });
    await waitForPageReady(page, 2500);
    await saveScreenshot(page, 'mobile_23_tenant_digital_contract.png');

    // Tenant Announcements
    await page.goto(`${BASE_URL}/tenant/announcements`, { waitUntil: 'networkidle2' });
    await waitForPageReady(page, 2500);
    await saveScreenshot(page, 'mobile_24_tenant_announcements_board.png');

    // Tenant Move-Out
    await page.goto(`${BASE_URL}/tenant/move-out`, { waitUntil: 'networkidle2' });
    await waitForPageReady(page, 2500);
    await saveScreenshot(page, 'mobile_25_tenant_moveout_request.png');

    // ==========================================
    // 4. KEEPER MOBILE
    // ==========================================
    console.log('\n🧹 --- 4. Keeper & Staff Dimension (Mobile) ---');
    await page.goto(`${BASE_URL}/keeper`, { waitUntil: 'networkidle2' });
    await waitForPageReady(page, 2500);
    await saveScreenshot(page, 'mobile_26_keeper_dashboard.png');

    await page.goto(`${BASE_URL}/keeper/maid`, { waitUntil: 'networkidle2' });
    await waitForPageReady(page, 2500);
    await saveScreenshot(page, 'mobile_27_keeper_maid_tasks.png');

    await page.goto(`${BASE_URL}/keeper/technician`, { waitUntil: 'networkidle2' });
    await waitForPageReady(page, 2500);
    await saveScreenshot(page, 'mobile_28_keeper_technician_jobs.png');

    // ==========================================
    // 5. PLATFORM SUPERADMIN MOBILE
    // ==========================================
    console.log('\n🛡️ --- 5. Platform Superadmin Dimension (Mobile) ---');
    await page.goto(`${BASE_URL}/signin`, { waitUntil: 'networkidle2' });
    ...
    await waitForPageReady(page, 2500);
    await saveScreenshot(page, 'mobile_29_platform_superadmin_dashboard.png');

    await page.goto(`${BASE_URL}/platform/dormitories`, { waitUntil: 'networkidle2' });
    await waitForPageReady(page, 2500);
    await saveScreenshot(page, 'mobile_30_platform_dormitories_registry.png');

    await page.goto(`${BASE_URL}/platform/packages`, { waitUntil: 'networkidle2' });
    await waitForPageReady(page, 2500);
    await saveScreenshot(page, 'mobile_31_platform_saas_packages.png');

    await page.goto(`${BASE_URL}/platform/accounting`, { waitUntil: 'networkidle2' });
    await waitForPageReady(page, 2500);
    await saveScreenshot(page, 'mobile_32_platform_accounting_revenue.png');

    console.log('\n🎉 ALL 32 MOBILE MULTI-DIMENSIONAL SCREENSHOTS SUCCESSFULLY CAPTURED!');

  } catch (err) {
    console.error('Error during mobile multi-dimension capture:', err);
  } finally {
    await browser.close();
  }
})();
