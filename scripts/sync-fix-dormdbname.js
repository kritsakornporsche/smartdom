...
const filesToUpload = [
  ...
  'app/api/booking/progress/route.ts',
  'app/api/auth/update-role/route.ts',
  'app/api/owner/contracts/[id]/route.ts',
  'app/api/owner/contracts/[id]/sign/route.ts',
  'app/api/owner/billing/[id]/route.ts',
  'app/api/owner/billing/batch/route.ts',
  'app/api/owner/maintenance/[id]/route.ts',
  'lib/version.json'
];

const conn = new Client();

console.log('Connecting SSH to sync API fixes to server...');
